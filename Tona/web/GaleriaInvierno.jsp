...
<html>
    ...
    <!--        <div class="modal-img" id="imgModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-body"> 
                    <div class="imagen">
                        <img class="modal-cont " id="img01">
                        <spam onclick="imgModal.style.display = 'none'" class="close-img">&times;</spam>
                    <div  id="caption"></div>
                    </div>
                </div>
            </div>-->
